<div id="data-table">
                            ...
                            <script type="text/javascript">
                                           ...
                                           $("#aopportunite<?php echo $_GET["id"]; ?>").fancybox({
                                            'width'				: 730,
                                            'height'			: 350,
                                            'type'				: 'iframe',								
											'onClosed': function(e)
    ...
    <table class="style1 datatable">
        <thead>
			...
			<a id="popportunite<?php echo $row["id_opportunite"];?>" href="insertion/opportunite-projet.php?id=<?php echo $row["id_opportunite"];?>" class="button grey size-30" title="convertir en projet">Convertir</a>
			  ...
			  <td><a id="mopportunite<?php echo $row["id_opportunite"];?>" href="insertion/modif-opportunite-compte.php?id=<?php echo $row["id_opportunite"];?>" title="Modifier cette opportunite de <?php echo $_GET["nom"];?>  "><img src="images/ico_edit_16.png"  width="16" /></a>
                                            <script type="text/javascript">
