...
$("#acontact<?php echo $_GET["id"]; ?>").fancybox({
'width'				: 1080,
'height'			: 370,
'type'				: 'iframe',
'onClosed': function(e)
...
<td><a id="mcontact<?php echo $row["id_contact"];?>" href="insertion/modif-contact-compte.php?id=<?php echo $row["id_contact"];?>" title="Modifier ce contact"> <img src="images/ico_edit_16.png"  width="16" /> </a>
<script type="text/javascript">
...
<form id="form-sup-contact<?php echo $row["id_contact"];?>" style="width:300px;" method="post"
action="" class="notification note-error">
<center>
...
header("location:index.php?page=suivi-compte&id=1&nom=ISET");
}
?>
