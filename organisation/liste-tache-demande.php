<div id="data-table">
    <h1>Les T&acirc;che de projet:&nbsp; <?php echo $_GET["nom"];?></h1> <p><a href="index.php?page=demande-congée">
    <img src="images/return.png" width="32" /></a></p>	
    <p align="right"> <a id="atache<?php echo $_GET["id"]; ?>" href="index.php?page=demande-congée<?php echo $_GET["id"]; ?>&idc=<?php echo $_GET["idc"]; ?>" class="button blue size-30" title="Ajouter une tache &agrave; <?php echo $_GET["nom"];?>">Ajouter</a>
