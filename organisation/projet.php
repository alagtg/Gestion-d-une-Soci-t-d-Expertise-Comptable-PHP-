<div id="data-table">
<h1>G&eacute;rer les projets</h1>
<p align="right"><a href="insertion/projet.php" id="gerer-projet" class="button blue size-80" title="Ajouter un projet">Ajouter</a></p>
 ...
 <td><a href="index.php?page=taches-projet&id=<?php echo $row["id_projet"];?>&nom=<?php echo $row["nom"];?>&idc=<?php echo $row["id_compte"];?>" > <img src="images/tache.png"  width="16" /></a> </td>
