...
$req1= "SELECT* FROM `ligne` where id_compte=".$_GET["id"];
try {
...
<td><a href="index.php?page=taches-demande-compte&id=<?php echo $row["id_projet"];?>&nom=<?php echo $row["nom"];?>&idc=<?php echo $row["id_compte"];?>&nomc=<?php echo $_GET["nom"];?>" > <img src="images/tache.png"  width="16" /></a> </td>


<td><a id="mprojet<?php echo $row["id_projet"];?>" href="insertion/modif-demande-compte.php?id=<?php echo $row["id_projet"];?>" title="Modifier ce projet" > <img src="images/ico_edit_16.png"  width="16" /></a>
<script type="text/javascript">
