...
echo'Aucun';
 ...
 <td>
<a id="mtache<?php echo $row["id_tache"];?>" href="insertion/modif-tache-compte.php?id=<?php echo $row["id_tache"];?>"title="Modifier une tache"><img src="images/ico_edit_16.png"  width="16" /></a>
          <script type="text/javascript">
