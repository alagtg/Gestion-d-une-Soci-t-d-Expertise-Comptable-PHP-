<center><h1>Profil : <?php echo strtoupper($_SESSION["prenom"]." ".$_SESSION["nom"]);?></h1></center>
<div id="data-table">

    <h1>Les T&acirc;cche de projet:&nbsp; <?php echo $_GET["nom"];?></h1> <p><a href="index.php?page=profil">
