<div id="data-table">
  <h1>G&eacute;rer les T&acirc;ches</h1>
  <p align="right"><a href="insertion/tache.php" id="gerer-tache" class="button blue size-80"
	title="Ajouter une tache">Ajouter</a></p>
...
//header("location:index.php?page=gerer-taches");
 }
?>