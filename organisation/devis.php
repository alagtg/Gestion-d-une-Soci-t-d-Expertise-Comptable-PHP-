	<div id="data-table">
	<h1>G&eacute;rer les devis</h1> 
	<p align="right"><a href="index.php?page=creer-devis" id="gerer-devis" title="Ajouter devis" class="button blue size-80">Ajouter</a></p>	                       
	...
	<td><?php echo date_fr($row["date_devis"]);?></td>
	...
	//header("location:index.php?page=gerer-devis");jdida
