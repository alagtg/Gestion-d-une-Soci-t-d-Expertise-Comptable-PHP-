<center><h1>compte	: <?php echo strtoupper($_GET["nomc"]);?></h1></center>
<div id="data-table">
    <h1>les T&acirc;che de projet:&nbsp; <?php echo $_GET["nom"];?></h1> <p><a href="index.php?page=suivi-compte&id=<?php echo $_GET["idc"]; ?>&nom=<?php echo $_GET["nomc"]; ?>">
    <img src="images/return.png" width="32" /></a></p>	
    <p align="right"> <a id="atache<?php echo $_GET["id"]; ?>" href="insertion/tache-demande.php?id=<?php echo $_GET["id"]; ?>&idc=<?php echo $_GET["idc"]; ?>" class="button blue size-30" title="Ajouter une tache &agrave; <?php echo $_GET["nom"];?>">Ajouter</a>
