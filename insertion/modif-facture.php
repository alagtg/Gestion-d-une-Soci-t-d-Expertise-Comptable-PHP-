...
<?php
	...
	$req= "SELECT * FROM `facture` WHERE id_facture=".$_GET['id'];
  try {
...
$req2="update  facture SET `reference` = '$reference',`qte` = '$qte',`prix` = '$prix',`id_compte` = '$compte'
,`id_produit` = '$produit'  WHERE `id_facture`=".$_GET['id']; 
 try {
