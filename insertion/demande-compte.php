...
<?php
 ...
 if(isset($_POST["submit"]))
  {
   $req3= "insert into ligne(id_projet,description,etat,debut,echeance,creer,realiser,id_compte,ca_global) values('','$description','$etat','$debut','$echeance','$creer','$realiser','$compte','$ca')";
   try {
