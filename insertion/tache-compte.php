...
<form id="formID" class="formular" method="post" action="">
			...
			<font color="red">(*)champs Obligatoires</font>
				...
				<select name="etat" id="etat"  class="validate[required]" style="width:200px" >
					...
					<option value="Non commencée">Non commenc&eacute;e</option>
					<option value="En cours">En cours</option>
					<option value="Fini">Fini</option>
					<option value="Abandonnée">Abandonn&eacute;e</option>
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<select name="projet" id="projet"   style="width:200px" >
				  ...
				  require("../connect.php");
				  session_start();
  $req= "SELECT* FROM `projet` where id_compte=".$_GET["id"];
  try {
...
{
?>
					<option value="<?php echo $row["id_projet"];?>"><?php echo $row["nom"];?></option>
					<?php }
...
<?php
 ...
 $projet= addslashes($_POST['projet']); 
  ...
  $req1= "insert into tache (id_tache,etat,debut,echeance,priorite,description,id_compte,id_projet,creer,realiser)values('','$etat','$debut','$echeance','$priorite','$description','$montant','$compte','$projet',' $creer','$realiser')";
  try {
