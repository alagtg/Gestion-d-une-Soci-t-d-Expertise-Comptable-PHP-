...
<title>Convertir opportuniter  en demande</title>
...
?>
   ...
   $req2= "insert into ligne(id_projet,nom,description,etat,debut,echeance,creer,realiser,id_compte,ca_global) values('','$nom','$description','$etat','$debut','$echeance','$creer','$realiser','$compte','$ca')";
   try {
