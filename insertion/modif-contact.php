...
$utilisateur=addslashes($_POST['utilisateur']);
   ...
   $req3= "update contact SET `civilite` ='$civilite', `nom` = '$nom',`prenom` = '$prenom',`titre` = '$titre',`telephone` ='$telephone',`mobile` ='$mobile',`fax` = '$fax',`mail` = '$email',`skype` = '$skype' , `id_compte` = '$compte' WHERE `id_contact` = ".$_GET['id']; 
