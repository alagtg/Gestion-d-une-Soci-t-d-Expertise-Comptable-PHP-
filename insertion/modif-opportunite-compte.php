...
<form id="formID" class="formular" method="post" action="">
  ...
  <input name="fin" id="start-date" value="<?php echo $row["fin"];?>" class="validate[required] date-pick dp-applied "  >
  </label>
  </td>
                <td>
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 if(isset($_POST["submit"]))
  {
   ...
   $req2= "update  opportunite SET `description` = '$description',`etat` = '$etat',`debut` = '$debut',`fin` = '$fin',`ca_global` = '$ca' WHERE `id_opportunite` = ".$_GET["id"];
   try {
