...
?>
  ...
  <input class="validate[required] text-input" type="text" name="ca"  id="ca" value="<?php echo $row["ca_global"];?>"style="width:200px" />
  </label>
 ...
 if(isset($_POST["submit"]))
  {
   ...
   $req2= "update  projet SET `description` = '$description',`etat` = '$etat',`debut` = '$debut',`echeance` = '$fin',`realiser` = '$realiser',`ca_global` = '$ca' WHERE `id_projet`=".$_GET['id']; 
   try {
