 ...
 if(isset($_POST["submit"]))
  {
   ...
   $req3= "insert into projet(id_projet,nom,description,etat,debut,echeance,creer,realiser,id_compte,ca_global) values('','$nom','$description','$etat','$debut','$echeance','$creer','$realiser','$compte','$ca')";
   try {
