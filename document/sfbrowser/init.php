...
$sPhpLang = SFB_PATH."lang/".SFB_LANG.".php";
$sJsLang = SFB_PATH."lang/".SFB_LANG.".js";
...
$aIcons = array();
if ($handle = opendir(SFB_PATH."icons/"))
 while (false !== ($file = readdir($handle))) 
 if (filetype(SFB_PATH."icons/".$file)=="file"){
	$part = explode(".",$file);
	$aIcons[] = array_shift($part);
 }	
